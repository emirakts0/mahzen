...
// Render backend highlight markup (<mark> tags) as styled spans
function HighlightedText({ html }: { html: string }) {
  return (
    <span
      className="[&_mark]:rounded-sm [&_mark]:bg-primary/20 [&_mark]:px-0.5 [&_mark]:font-semibold [&_mark]:text-primary"
